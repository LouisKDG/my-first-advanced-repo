  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex">
      ...
      <div class="logo me-auto">
        ...
        <a href="index.html"><img src="assets/img/kursive_logo_box.png" alt="" class="img-fluid"></a>
      </div>

      <nav class="nav-menu d-none d-lg-block">
        <ul>
          <li class="active"><a href="index.html#hero">Home</a></li>
          <li class="drop-down"><a href="index.html#about">Over ons</a>
            <ul>
              <li><a href="index.html#about">Verhaal</a></li>
  ...
  <main id="main">
    ...
    <section id="portfolio-details" class="portfolio-details">
      <div class="container">
          ...
          <?php if ($portfolio == 'portfolio1'): ?>

          <div class="portfolio-details-container">
              <div class="owl-carousel portfolio-details-carousel">
                  <img src="assets/img/portfolio1-details-1.png" class="img-fluid" alt="">
                  <img src="assets/img/portfolio1-details-2.png" class="img-fluid" alt="">
              </div>

              <?php elseif ($portfolio == 'portfolio2'): ?>
              ...
              <div class="portfolio-details-container">
                  ...
                  <?php elseif ($portfolio == 'portfolio3'): ?>
                  ...
                  <div class="portfolio-details-container">
                      ...
                      <?php elseif ($portfolio == 'portfolio4'): ?>
